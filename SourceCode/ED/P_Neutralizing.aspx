<%@ Page Title="" Language="C#" MasterPageFile="~/NoFrame.master" AutoEventWireup="true" CodeFile="P_Neutralizing.aspx.cs" Inherits="ED_P_Neutralizing" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-2 form-group">
                                <label for="<%= TB_Temperature1.ClientID%>" class="control-label">
                                    <asp:Literal ID="L_Temperature1" runat="server"></asp:Literal>
                                </label>
                            ...
                            <div class="col-xs-2 form-group">
                                <label for="<%= TB_Temperature2.ClientID%>" class="control-label">
                                    <asp:Literal ID="L_Temperature2" runat="server"></asp:Literal>
                                </label>
