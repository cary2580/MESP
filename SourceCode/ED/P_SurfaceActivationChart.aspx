<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="P_SurfaceActivationChart.aspx.cs" Inherits="ED_P_SurfaceActivationChart" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MasterHead" runat="Server">
    <script type="text/javascript">
        function PostBackCheck()
        {
            ...
            if (!$("#<%=CB_SurfaceActivation.ClientID%>,#<%=CB_Phosphating.ClientID%>").is(":checked"))
            {
                IsPostBack = false;
            ...
            <div class="panel-body">
                ...
                <div class="col-xs-6 form-group">
                    ...
                    <label class="checkbox-inline">
                        <asp:CheckBox ID="CB_SurfaceActivation" runat="server" />
                        <asp:Literal ID="L_SurfaceActivation" runat="server"></asp:Literal>
                    </label>
                    <label class="checkbox-inline">
                        <asp:CheckBox ID="CB_Phosphating" runat="server" />
                        <asp:Literal ID="L_Phosphating" runat="server"></asp:Literal>
                    </label>
                </div>
                <div class="col-xs-6 form-group">
                    <label>
                    ...
                    <label class="radio-inline">
                        <asp:RadioButton ID="RB_FreeAcid" runat="server" GroupName="RB_Parameter" />
                        <asp:Literal runat="server" Text="<%$ Resources:ProjectGlobalRes,Str_ED_P_FreeAcidValue %>"></asp:Literal>
                    </label>
                    <label class="radio-inline">
                        <asp:RadioButton ID="RB_TotalAcidity" runat="server" GroupName="RB_Parameter" />
                        <asp:Literal runat="server" Text="<%$ Resources:ProjectGlobalRes,Str_ED_P_TotalAcidity %>"></asp:Literal>
                    </label>
                    <label class="radio-inline">
                        <asp:RadioButton ID="RB_PromotionPoint" runat="server" GroupName="RB_Parameter" />
                        <asp:Literal runat="server" Text="<%$ Resources:ProjectGlobalRes,Str_ED_P_PromotionPointValue %>"></asp:Literal>
                    </label>
                </div>
                <div class="col-xs-6 form-group">
                    <label>
