<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="P_CoatingTestForPDChart.aspx.cs" Inherits="ED_P_CoatingTestForPDChart" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MasterHead" runat="Server">
    <script type="text/javascript">
        function PostBackCheck()
        {
            ...
            if (!$("#<%=CB_FilmThickness.ClientID%>").is(":checked"))
            {
                IsPostBack = false;
            ...
            <div class="panel-body">
                ...
                <div class="col-xs-6 form-group">
                    ...
                    <label class="checkbox-inline">
                        <asp:CheckBox ID="CB_FilmThickness" runat="server" />
                        <asp:Literal ID="L_FilmThickness" runat="server"></asp:Literal>
                    </label>
                </div>
                <div class="col-xs-6 form-group">
                    <label>
                    ...
                    <label class="radio-inline">
                        <asp:RadioButton ID="RB_FilmThickness" runat="server" GroupName="RB_Parameter" Checked="true" />
