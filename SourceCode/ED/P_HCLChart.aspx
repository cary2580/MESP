<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="P_HCLChart.aspx.cs" Inherits="ED_P_HCLChart" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MasterHead" runat="Server">
    <script type="text/javascript">
        function PostBackCheck()
        {
            ...
            if (!$("#<%=CB_HCL1.ClientID%>,#<%=CB_HCL2.ClientID%>,#<%=CB_Neutralizing.ClientID%>").is(":checked"))
            {
                IsPostBack = false;
            ...
            <div class="panel-body">
                ...
                <div class="col-xs-6 form-group">
                    ...
                    <label class="checkbox-inline">
                        <asp:CheckBox ID="CB_HCL1" runat="server" />
                        <asp:Literal ID="L_HCL1" runat="server"></asp:Literal>
                    </label>
                    <label class="checkbox-inline">
                        <asp:CheckBox ID="CB_HCL2" runat="server" />
                        <asp:Literal ID="L_HCL2" runat="server"></asp:Literal>
                    </label>
                    <label class="checkbox-inline">
                        <asp:CheckBox ID="CB_Neutralizing" runat="server" />
                        <asp:Literal ID="L_Neutralizing" runat="server"></asp:Literal>
                    </label>
                </div>
                <div class="col-xs-6 form-group">
                    <label>
                    ...
                    <label class="radio-inline">
                        <asp:RadioButton ID="RB_PValue" runat="server" GroupName="RB_Parameter" />
                        <asp:Literal runat="server" Text="<%$ Resources:ProjectGlobalRes,Str_ED_P_PValue %>"></asp:Literal>
                    </label>
                    <label class="radio-inline">
