<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="P_WaterRinsingChart.aspx.cs" Inherits="ED_P_WaterRinsingChart" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MasterHead" runat="Server">
    <script type="text/javascript">
        function PostBackCheck()
        {
            ...
            if (!$("#<%=CB_WaterRinsing1.ClientID%>,#<%=CB_WaterRinsing2.ClientID%>,#<%=CB_WaterRinsing3.ClientID%>,#<%=CB_WaterRinsing4.ClientID%>,#<%=CB_WaterRinsing5.ClientID%>,#<%=CB_WaterRinsing6.ClientID%>,#<%=CB_WaterRinsing7.ClientID%>,#<%=CB_WaterRinsing8.ClientID%>,#<%=CB_DIWater1.ClientID%>,#<%=CB_DIWater2.ClientID%>").is(":checked"))
            {
                IsPostBack = false;
            ...
            <div class="panel-body">
                ...
                <div class="col-xs-6 form-group">
                    ...
                    <label class="checkbox-inline">
                        <asp:CheckBox ID="CB_WaterRinsing1" runat="server" />
                        <asp:Literal ID="L_WaterRinsing1" runat="server"></asp:Literal>
                    </label>
                    <label class="checkbox-inline">
                        <asp:CheckBox ID="CB_WaterRinsing2" runat="server" />
                        <asp:Literal ID="L_WaterRinsing2" runat="server"></asp:Literal>
                    </label>
                    <label class="checkbox-inline">
                        <asp:CheckBox ID="CB_WaterRinsing3" runat="server" />
                        <asp:Literal ID="L_WaterRinsing3" runat="server"></asp:Literal>
                    </label>
                    <label class="checkbox-inline">
                        <asp:CheckBox ID="CB_WaterRinsing4" runat="server" />
                        <asp:Literal ID="L_WaterRinsing4" runat="server"></asp:Literal>
                    </label>
                    <label class="checkbox-inline">
                        <asp:CheckBox ID="CB_WaterRinsing5" runat="server" />
                        <asp:Literal ID="L_WaterRinsing5" runat="server"></asp:Literal>
                    </label>
                    <label class="checkbox-inline">
                        <asp:CheckBox ID="CB_WaterRinsing6" runat="server" />
                        <asp:Literal ID="L_WaterRinsing6" runat="server"></asp:Literal>
                    </label>
                    <label class="checkbox-inline">
                        <asp:CheckBox ID="CB_WaterRinsing7" runat="server" />
                        <asp:Literal ID="L_WaterRinsing7" runat="server"></asp:Literal>
                    </label>
                    <label class="checkbox-inline">
                        <asp:CheckBox ID="CB_WaterRinsing8" runat="server" />
                        <asp:Literal ID="L_WaterRinsing8" runat="server"></asp:Literal>
                    </label>
                    <label class="checkbox-inline">
                        <asp:CheckBox ID="CB_DIWater1" runat="server" />
                        <asp:Literal ID="L_DIWater1" runat="server"></asp:Literal>
                    </label>
                    <label class="checkbox-inline">
                        <asp:CheckBox ID="CB_DIWater2" runat="server" />
                        <asp:Literal ID="L_DIWater2" runat="server"></asp:Literal>
                    </label>
                </div>
                <div class="col-xs-6 form-group">
                    <label>
