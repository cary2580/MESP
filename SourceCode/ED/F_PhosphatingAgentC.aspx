<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="F_PhosphatingAgentC.aspx.cs" Inherits="ED_F_PhosphatingAgentC" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MasterHead" runat="Server">
    <script type="text/javascript">
        ...
        {
            $.Ajax({
                url: "<%= ResolveClientUrl(@"~/ED/Service/FormulaDateChange.ashx?IsB=") + false.ToStringValue() %>",
        ...
        {
            $.OpenPage({
                Framesrc: "<%= ResolveClientUrl(@"~/ED/F_PhosphatingAgentC_M.aspx") %>",
                ...
                width: 800,
                height: 680,
                NewWindowPageDivID: "F_PhosphatingAgentC_M_DivID",
                NewWindowPageFrameID: "F_PhosphatingAgentC_M_Frame",
