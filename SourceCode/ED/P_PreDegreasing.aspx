<%@ Page Title="" Language="C#" MasterPageFile="~/NoFrame.master" AutoEventWireup="true" CodeFile="P_PreDegreasing.aspx.cs" Inherits="ED_P_PreDegreasing" %>
            ...
            <div class="panel-body">
                ...
                <div class="panel <%=(string)GetGlobalResourceObject("GlobalRes","Str_FormPanelTitleColor1") %>">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-xs-3 form-group">
                            <label for="TB_HValue" class="control-label">
