...
public partial class ED_P_UF1 : System.Web.UI.Page
{
    /// <summary>
    /// 目前寫死，因此這個值必須要跟T_Code的ChemicalAdding對的上
    /// </summary>
    protected string CACategoryID = "CA15";
    ...
    protected void LoadChemicalAddingTitle()
    {
        ...
        CA15_Title.Text = ChemicalAdding_HeadText;

        if (CA1Row != null)
            CA15_Title.Text += "-" + CA1Row["CodeName"].ToString().Trim();
    }
    ...
    protected void LoadPrametersRemark()
    {
        ...
        dbcb.appendParameter(Util.GetDataAccessAttribute("Prameters", "nvarchar", 10000, "EDP101|EDP102|EDP103|EDP104"));

        DataTable DT = CommonDB.ExecuteSelectQuery(dbcb);

        DataRow EDP101Row = DT.AsEnumerable().Where(Row => Row["PrametersID"].ToString().Trim() == "EDP101").FirstOrDefault();

        DataRow EDP102Row = DT.AsEnumerable().Where(Row => Row["PrametersID"].ToString().Trim() == "EDP102").FirstOrDefault();

        DataRow EDP103Row = DT.AsEnumerable().Where(Row => Row["PrametersID"].ToString().Trim() == "EDP103").FirstOrDefault();

        DataRow EDP104Row = DT.AsEnumerable().Where(Row => Row["PrametersID"].ToString().Trim() == "EDP104").FirstOrDefault();

        if (EDP101Row != null)
        {
            string MaxValue = ((decimal)EDP101Row["MaxValue"]).ToString("0.##");
            string MinValue = ((decimal)EDP101Row["MinValue"]).ToString("0.##");
        ...
        if (EDP102Row != null)
        {
            ...
            string MaxValue = ((decimal)EDP102Row["MaxValue"]).ToString("0.##");
            string MinValue = ((decimal)EDP102Row["MinValue"]).ToString("0.##");
        ...
        if (EDP103Row != null)
        {
            string MaxValue = ((decimal)EDP103Row["MaxValue"]).ToString("0.##");
            string MinValue = ((decimal)EDP103Row["MinValue"]).ToString("0.##");
        ...
        if (EDP104Row != null)
        {
            ...
            string MaxValue = ((decimal)EDP104Row["MaxValue"]).ToString("0.##");
            string MinValue = ((decimal)EDP104Row["MinValue"]).ToString("0.##");
    ...
    protected void LoadData()
    {
        ...
        ObjectSchema Schema = DBSchema.currentDB.Tables["T_EDPUF1"];

        string Query = "Select *,Base_Org.dbo.GetAccountName(CreateAccountID) AS CreateAccountName,Base_Org.dbo.GetAccountName(ModifyAccountID) AS ModifyAccountName From T_EDPUF1 Where PID = @PID";
            ...
            if (R["CategoryID"].ToString().Trim() == CACategoryID)
            {
                if ((short)R["SerialNo"] == 1)
                {
                    ...
                    if (AddDateTime.Year > 1911)
                        TB_CA15_AddDateTime1.Text = AddDateTime.ToDefaultString("HH:mm:ss");

                    decimal Qty = (decimal)R["Qty"];

                    if (Qty > -1)
                        TB_CA15_Qty1.Text = Qty.ToString();

                    TB_CA15_LotNumber1.Text = R["LotNumber"].ToString().Trim();
                ...
                else if ((short)R["SerialNo"] == 2)
                {
                    ...
                    if (AddDateTime.Year > 1911)
                        TB_CA15_AddDateTime2.Text = AddDateTime.ToDefaultString("HH:mm:ss");

                    decimal Qty = (decimal)R["Qty"];

                    if (Qty > -1)
                        TB_CA15_Qty2.Text = Qty.ToString();

                    TB_CA15_LotNumber2.Text = R["LotNumber"].ToString().Trim();
                ...
                else if ((short)R["SerialNo"] == 3)
                {
                    ...
                    if (AddDateTime.Year > 1911)
                        TB_CA15_AddDateTime3.Text = AddDateTime.ToDefaultString("HH:mm:ss");

                    decimal Qty = (decimal)R["Qty"];

                    if (Qty > -1)
                        TB_CA15_Qty3.Text = Qty.ToString();

                    TB_CA15_LotNumber3.Text = R["LotNumber"].ToString().Trim();
                ...
                else if ((short)R["SerialNo"] == 4)
                {
                    ...
                    if (AddDateTime.Year > 1911)
                        TB_CA15_AddDateTime4.Text = AddDateTime.ToDefaultString("HH:mm:ss");

                    decimal Qty = (decimal)R["Qty"];

                    if (Qty > -1)
                        TB_CA15_Qty4.Text = Qty.ToString();

                    TB_CA15_LotNumber4.Text = R["LotNumber"].ToString().Trim();
    ...
    protected void BT_Submit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (string.IsNullOrEmpty(HF_PID.Value))
            {
                ...
                Query = @"Insert Into T_EDPUF1 (PID,PDate,WorkClassID,PLID,PHValue1,PHValue2,ProcessSecond,Conductivity1,Conductivity2,Solid,Remark,CreateAccountID) 
                ...
                PID = BaseConfiguration.SerialObject[(short)10].取號();
            ...
            else
            {
                ...
                Query = @"Update T_EDPUF1 Set PDate = @PDate,WorkClassID = @WorkClassID,PLID = @PLID,PHValue1 = @PHValue1,PHValue2 = @PHValue2,ProcessSecond = @ProcessSecond,Conductivity1 = @Conductivity1,Conductivity2 = @Conductivity2,Solid = @Solid,
            ...
            if (!string.IsNullOrEmpty(TB_CA15_AddDateTime1.Text.Trim()) && !string.IsNullOrEmpty(TB_CA15_Qty1.Text.Trim()))
                DBA.AddCommandBuilder(Util.ED.GetCreateCADBCB(PID, SerialNo, CACategoryID, PDate, TB_CA15_AddDateTime1, TB_CA15_Qty1, TB_CA15_LotNumber1));
            else if (!string.IsNullOrEmpty(TB_CA15_AddDateTime1.Text.Trim() + TB_CA15_Qty1.Text.Trim()) && (!string.IsNullOrEmpty(TB_CA15_Qty1.Text.Trim()) && double.Parse(TB_CA15_Qty1.Text.Trim()) > 0))
            ...
            if (!string.IsNullOrEmpty(TB_CA15_AddDateTime2.Text.Trim()) && !string.IsNullOrEmpty(TB_CA15_Qty2.Text.Trim()))
                DBA.AddCommandBuilder(Util.ED.GetCreateCADBCB(PID, SerialNo, CACategoryID, PDate, TB_CA15_AddDateTime2, TB_CA15_Qty2, TB_CA15_LotNumber2));
            else if (!string.IsNullOrEmpty(TB_CA15_AddDateTime2.Text.Trim() + TB_CA15_Qty2.Text.Trim()) && (!string.IsNullOrEmpty(TB_CA15_Qty2.Text.Trim()) && double.Parse(TB_CA15_Qty2.Text.Trim()) > 0))
                throw new Exception((string)GetGlobalResourceObject("ProjectGlobalRes", "Str_ED_P_RequiredByCA"));
            ...
            if (!string.IsNullOrEmpty(TB_CA15_AddDateTime3.Text.Trim()) && !string.IsNullOrEmpty(TB_CA15_Qty3.Text.Trim()))
                DBA.AddCommandBuilder(Util.ED.GetCreateCADBCB(PID, SerialNo, CACategoryID, PDate, TB_CA15_AddDateTime3, TB_CA15_Qty3, TB_CA15_LotNumber3));
            else if (!string.IsNullOrEmpty(TB_CA15_AddDateTime3.Text.Trim() + TB_CA15_Qty3.Text.Trim()) && (!string.IsNullOrEmpty(TB_CA15_Qty3.Text.Trim()) && double.Parse(TB_CA15_Qty3.Text.Trim()) > 0))
                throw new Exception((string)GetGlobalResourceObject("ProjectGlobalRes", "Str_ED_P_RequiredByCA"));
            ...
            if (!string.IsNullOrEmpty(TB_CA15_AddDateTime4.Text.Trim()) && !string.IsNullOrEmpty(TB_CA15_Qty4.Text.Trim()))
                DBA.AddCommandBuilder(Util.ED.GetCreateCADBCB(PID, SerialNo, CACategoryID, PDate, TB_CA15_AddDateTime4, TB_CA15_Qty4, TB_CA15_LotNumber4));
            else if (!string.IsNullOrEmpty(TB_CA15_AddDateTime4.Text.Trim() + TB_CA15_Qty4.Text.Trim()) && (!string.IsNullOrEmpty(TB_CA15_Qty4.Text.Trim()) && double.Parse(TB_CA15_Qty4.Text.Trim()) > 0))
                throw new Exception((string)GetGlobalResourceObject("ProjectGlobalRes", "Str_ED_P_RequiredByCA"));
    ...
    protected void BT_Delete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            Util.ED.DeletEDData(HF_PID.Value.ToStringFromBase64(), ((short)Util.ED.PIDType.T_EDPUF1), true);
