<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="P_CuringChart.aspx.cs" Inherits="ED_P_CuringChart" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MasterHead" runat="Server">
    <script type="text/javascript">
        function PostBackCheck()
        {
            ...
            if (!$("#<%=CB_Zone1Fan1.ClientID%>,#<%=CB_Zone2Fan2.ClientID%>,#<%=CB_Combustor.ClientID%>").is(":checked"))
            {
                IsPostBack = false;
            ...
            <div class="panel-body">
                ...
                <div class="col-xs-6 form-group">
                    ...
                    <label class="checkbox-inline">
                        <asp:CheckBox ID="CB_Zone1Fan1" runat="server" />
                        <asp:Literal ID="L_Zone1Fan1" runat="server"></asp:Literal>
                    </label>
                    <label class="checkbox-inline">
                        <asp:CheckBox ID="CB_Zone2Fan2" runat="server" />
                        <asp:Literal ID="L_Zone2Fan2" runat="server"></asp:Literal>
                    </label>
                    <label class="checkbox-inline">
                        <asp:CheckBox ID="CB_Combustor" runat="server" />
                        <asp:Literal ID="L_Combustor" runat="server"></asp:Literal>
                    </label>
                </div>
                <div class="col-xs-6 form-group">
                    <label>
                        <asp:Literal runat="server" Text="<%$ Resources:ProjectGlobalRes,Str_ED_P_ParameterName %>"></asp:Literal>
                    </label>
                    <p></p>
                    <label class="radio-inline">
                        <asp:RadioButton ID="RB_Temperature" runat="server" GroupName="RB_Parameter" Checked="true" />
