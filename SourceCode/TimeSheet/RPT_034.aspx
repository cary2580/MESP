<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RPT_034.aspx.cs" Inherits="TimeSheet_RPT_034" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MasterHead" runat="Server">
    <script type="text/javascript">
        $(function ()
        {
            ...
            {
                $.Ajax({
                    url: "<%=ResolveClientUrl(@"~/TimeSheet/Service/RPT_034.ashx")%>",
                    timeout: 600 * 1000,
                    data: { ReportDateStart: $("#<%=TB_ReportDateStart.ClientID%>").val(), ReportDateEnd: $("#<%=TB_ReportDateEnd.ClientID%>").val() },
