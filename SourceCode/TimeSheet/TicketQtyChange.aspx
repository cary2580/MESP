<%@ Page Title="" Language="C#" MasterPageFile="~/TimeSheet/TimeSheet.master" AutoEventWireup="true" CodeFile="TicketQtyChange.aspx.cs" Inherits="TimeSheet_TicketQtyChange" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" runat="Server">
    ...
    <div class="col-xs-12">
        <div class="col-xs-4 form-group required">
            <label for="<%= TB_TickeID.ClientID%>" class="control-label">
                <asp:Literal runat="server" Text="<%$ Resources:Str_TS_ScanTicketID%>"></asp:Literal>
            </label>
    ...
    <div class="col-xs-12">
        <div class="col-xs-2 form-group">
            <input id="BT_Change" type="button" value="<%= (string)GetGlobalResourceObject("GlobalRes","Str_BT_ConfirmName" )%>" class="btn btn-primary" />
            <asp:Button ID="BT_Submit" runat="server" Text="<%$ Resources:GlobalRes,Str_BT_ConfirmName %>" OnClick="BT_Submit_Click" UseSubmitBehavior="false" />
        </div>
    </div>
</asp:Content>
