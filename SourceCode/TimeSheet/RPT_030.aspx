<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RPT_030.aspx.cs" Inherits="TimeSheet_RPT_030" %>
    ...
    <script type="text/javascript">
        $(function ()
        {
            $("#BT_Export").click(function () {
                $.Ajax({
                    url: "<%=ResolveClientUrl(@"~/TimeSheet/Service/RPT_030.ashx")%>",
                    timeout: 600 * 1000,
                    data: { ReportDateStart: $("#<%=ReportDateStart.ClientID%>").val(), ReportDateEnd: $("#<%=ReportDateEnd.ClientID%>").val(), ProcessID: $("#<%=DLL_ProcessID.ClientID%>").val() },
    ...
    <div class="panel <%=(string)GetGlobalResourceObject("GlobalRes","Str_FormPanelTitleColor9") %>">
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-4 form-group">
                <label for="<%= DLL_ProcessID.ClientID%>" class="control-label">
                    <asp:Literal runat="server" Text="<%$ Resources:Str_ProcessID%>"></asp:Literal>
                </label>
                <asp:DropDownList ID="DLL_ProcessID" runat="server" CssClass="form-control" required="required">
                </asp:DropDownList>
            </div>
