...
public partial class TimeSheet_IT_ModifyPayrollType : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            Util.LoadDDLData(DDL_PayrollType, "TS_PayrollType", true);
    ...
    protected void BT_Confirm_Click1(object sender, EventArgs e)
    {
        try
        {
