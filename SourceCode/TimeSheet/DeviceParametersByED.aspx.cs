...
public partial class TimeSheet_DeviceParametersByED : System.Web.UI.Page
{
    ...
    protected void BT_Search_Click(object sender, EventArgs e)
    {
        ...
        string Query = @"Select 
                        ...
                        Where Datediff(day,@ReportDateStart,ReportDate) >= 0 And Datediff(day,@ReportDateEnd,ReportDate) <= 0";
        ...
        var ResponseData = new
        {
            colModel = Columns.Select(Column => new
            {
                ...
                classes = Column.ColumnName == "MachineName" ? BaseConfiguration.JQGridColumnClassesName : string.Empty,
            }),
            ...
            Rows = DT.AsEnumerable().Select(Row => new
            {
                ...
                ChangeWaterMinute = Row["ChangeWaterMinute"].ToString().Trim(),
                StandardMinute = Row["StandardMinute"].ToString().Trim()
            })
        };
    ...
    protected string GetListLabel(string ColumnName)
    {
        switch (ColumnName)
        {
            ...
            case "ChangeWaterMinute":
                return (string)GetLocalResourceObject("Str_ColumnName_ChangeWaterMinute");
            case "StandardMinute":
                return (string)GetLocalResourceObject("Str_ColumnName_StandardMinute");
            default:
                return ColumnName;
        }
    }
