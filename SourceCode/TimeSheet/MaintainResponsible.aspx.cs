...
public partial class TimeSheet_MaintainResponsible : System.Web.UI.Page
{
    ...
    {
        string Query = @"Select * From T_TSMaintainResponsible Order By SortID";
        ...
        var ResponseData = new
        {
            colModel = Columns.Select(Column => new
            {
                ...
                classes = Column.ColumnName == "ResponsibleName" ? BaseConfiguration.JQGridColumnClassesName : string.Empty,
            }),
            ResponsibleNameColumnName = "ResponsibleName",
            ...
            {
                ResponsibleID = Row["ResponsibleID"].ToString().Trim(),
    ...
    protected string GetListLabel(string ColumnName)
    {
        switch (ColumnName)
        {
            case "ResponsibleName":
                return (string)GetLocalResourceObject("Str_ColumnName_ResponsibleName");
            case "SortID":
