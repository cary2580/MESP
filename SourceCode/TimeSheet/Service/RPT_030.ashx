<%@ WebHandler Language="C#" Class="RPT_030" %>
...
public class RPT_030 : BasePage
{
    ...
    protected string ReportTemplateName = "RPT_030.xlsx";
    ...
    public override void ProcessRequest(HttpContext context)
    {
        try
        {
            ...
            DownloadFileInfo RI = new DownloadFileInfo { IsNoClearSession = false, IsDeleteDownloadFile = true, DownloadFileFullPath = SaveFullPath, SaveFileName = "RPT_030_" + DateTime.Now.ToString("yyMMddHHmmss") + ".xlsx" };
    ...
    {
        DbCommandBuilder dbcb = new DbCommandBuilder("SP_TS_RPT_030");
        ...
        dbcb.appendParameter(Util.GetDataAccessAttribute("ProcessID", "nvarchar", 50, ProcessID));
