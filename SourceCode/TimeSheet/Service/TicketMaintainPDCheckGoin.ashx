<%@ WebHandler Language="C#" Class="TicketMaintainPDCheckGoin" %>
...
public class TicketMaintainPDCheckGoin : BasePage
{
    ...
    public override void ProcessRequest(HttpContext context)
    {
        try
        {
            ...
            string Query = @"Update T_TSTicketMaintain Set PDCheckTimeStart = GetDate(),PDCheckTimeEnd = @PDCheckTimeEnd,PDCheckMinute = 0,PDCheckAccountID = -1 Where MaintainID = @MaintainID";

            ObjectSchema Schema = DBSchema.currentDB.Tables["T_TSTicketMaintain"];

            DbCommandBuilder dbcb = new DbCommandBuilder(Query);

            dbcb.appendParameter(Schema.Attributes["PDCheckTimeEnd"].copy(DateTime.Parse("1900/01/01")));
