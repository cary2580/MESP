<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RPT_013.aspx.cs" Inherits="TimeSheet_RPT_013" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MasterHead" runat="Server">
    <script type="text/javascript">
        $(function () {
            ...
            {
                if ($("#<%=ReportDateStart.ClientID%>").val() == "" || $("#<%=ReportDateEnd.ClientID%>").val() == "") {
                ...
                $.Ajax({
                    url: "<%=ResolveClientUrl(@"~/TimeSheet/Service/RPT_013.ashx")%>",
                    timeout: 600 * 1000,
                    data: { ReportDateStart: $("#<%=ReportDateStart.ClientID%>").val(), ReportDateEnd: $("#<%=ReportDateEnd.ClientID%>").val(), ProcessTypeID: $("#<%=DLL_ProcessType.ClientID%>").val() },
