<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RPT_026.aspx.cs" Inherits="TimeSheet_RPT_026" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MasterHead" runat="Server">
    <script type="text/javascript">
        $(function ()
        {
            ...
            {
                if ($("#<%=TB_ReportDateStart.ClientID%>").val() == "" && $("#<%=TB_ReportDateEnd.ClientID%>").val() == "" && $("#<%=TB_AUFNR.ClientID%>").val() == "")
                {
                ...
                $.Ajax({
                    url: "<%=ResolveClientUrl(@"~/TimeSheet/Service/RPT_026.ashx")%>",
                    timeout: 600 * 1000,
                    data: { ReportDateStart: $("#<%=TB_ReportDateStart.ClientID%>").val(), ReportDateEnd: $("#<%=TB_ReportDateEnd.ClientID%>").val(), AUFNR: $("#<%=TB_AUFNR.ClientID%>").val() },
