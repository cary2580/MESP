...
public partial class TimeSheet_IssueCategoryList : System.Web.UI.Page
{
    ...
    {
        string Query = @"Select * From T_TSIssueCategory Order By SortID";
        ...
        var ResponseData = new
        {
            colModel = Columns.Select(Column => new
            {
                ...
                classes = Column.ColumnName == "CategoryName" ? BaseConfiguration.JQGridColumnClassesName : string.Empty,
            }),
