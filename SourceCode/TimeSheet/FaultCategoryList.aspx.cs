...
public partial class TimeSheet_FaultCategoryList : System.Web.UI.Page
{
    ...
    {
        string Query = @"Select '' As FaultCategoryIDValue,* From T_TSFaultCategory";
        ...
        var ResponseData = new
        {
            colModel = Columns.Select(Column => new
            {
                ...
                classes = Column.ColumnName == "FaultCategoryID" ? BaseConfiguration.JQGridColumnClassesName : string.Empty,
            }),
