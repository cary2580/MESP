<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RPT_032.aspx.cs" Inherits="TimeSheet_RPT_032" %>
    ...
    <script type="text/javascript">
        $(function ()
        {
            $("#BT_Export").click(function () {
                $.Ajax({
                    url: "<%=ResolveClientUrl(@"~/TimeSheet/Service/RPT_032.ashx")%>",
                    timeout: 600 * 1000,
                    data: { ReportMonths: $("#<%=TB_ReportMonths.ClientID%>").val() },
