...
public partial class TimeSheet_RPT_009_Chart : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        TB_ReportDateEnd.Text = DateTime.Now.AddDays(-1).ToCurrentUICultureString();

        TB_ReportDateStart.Text = TB_ReportDateEnd.Text;
