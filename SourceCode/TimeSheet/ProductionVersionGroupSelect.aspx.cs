...
public partial class TimeSheet_ProductionVersionGroupSelect : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            var ResponseData = new
            {
                ...
                PVGroupNameColumnName = "PVGroupName",
    ...
    {
        string Query = @"Select PVGroupID,PVGroupName From T_TSProductionVersionGroup Group By PVGroupID,PVGroupName Order By PVGroupID";
