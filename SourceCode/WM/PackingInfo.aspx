<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PackingInfo.aspx.cs" Inherits="WM_PackingInfo" %>
            ...
            <div id="PackingInfoContent" class="panel-collapse collapse in" aria-expanded="true">
                <div class="panel-body">
                    ...
                    <div class="col-xs-3 form-group required">
                        ...
                        <asp:TextBox ID="TB_VBELN" runat="server" CssClass="form-control readonly"></asp:TextBox>
                    </div>
                    <div class="col-xs-3 form-group required">
                        ...
                        <asp:TextBox ID="TB_POSNR" runat="server" CssClass="form-control readonly"></asp:TextBox>
                    </div>
                    ...
                    <div class="col-xs-3 form-group">
                        <label for="<%= TB_SAPDeliveryNo.ClientID%>" class="control-label">
                            <asp:Literal runat="server" Text="<%$ Resources:ProjectGlobalRes,Str_WM_SAPDeliveryNo%>"></asp:Literal>
                        </label>
                        <asp:TextBox ID="TB_SAPDeliveryNo" runat="server" CssClass="form-control readonly"></asp:TextBox>
                    </div>
                    <div class="col-xs-3 form-group">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-xs-12 form-group">
                        ...
                        <asp:Button ID="BT_SendOut" runat="server" CssClass="btn btn-brown" Text="<%$ Resources:ProjectGlobalRes,Str_WM_PackingSendOut %>" OnClick="BT_SendOut_Click" Visible="false" />
                    </div>
                </div>
